...
import requests from colorama import Back , Fore , Style
...
def bitcoin_miner(t , restarted = False) :
    if restarted :
        ...
        print(Fore.MAGENTA , '[' , timer() , ']' , Fore.YELLOW , 'Programmer = XXSec101')
...
def StartMining() :
    ...
    print(Fore.BLUE , '--------------~~( ' , Fore.YELLOW , 'X X M 1 N 3 R' , Fore.BLUE , ' )~~--------------')
